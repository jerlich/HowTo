...
.. "ephys_at_swc/auto_examples_ephys/sara_mederos.py"
...
.. only:: html
    ...
    .. note::
        ...
        :ref:`Go to the end <sphx_glr_download_ephys_at_swc_auto_examples_ephys_sara_mederos.py>`
        to download the full example code.

.. rst-class:: sphx-glr-example-title

.. _sphx_glr_ephys_at_swc_auto_examples_ephys_sara_mederos.py:
...
.. _sphx_glr_download_ephys_at_swc_auto_examples_ephys_sara_mederos.py:
